    ...
    <?php 
        $questions=[
            ...
            "Perché il mio account è associato a un paese?"=>[
                "Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose: <ul><li>La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:<ul><li class='alphaList'>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</li><li class='alphaList'>Google LLC, con sede negli Stati Uniti, per il resto del mondo.</li></ul></li><li>La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.</li></ul>",
        ...
        foreach ($questions as $question => $paragraph) {
        ?>
            
            <h2><?php echo $question; ?></h2>
            <?php foreach ($paragraph as $paragraphText) {
                ?>
                <p><?php echo $paragraphText; ?>
                </p>
            <?php 
